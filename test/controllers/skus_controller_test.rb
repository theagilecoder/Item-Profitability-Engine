...
class SkusControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sku" do
    assert_difference('Sku.count') do
      post skus_url, params: { sku: { avgsaleprice: @sku.avgsaleprice, skuid: @sku.skuid, skuname: @sku.skuname } }
    end
  ...
  test "should update sku" do
    patch sku_url(@sku), params: { sku: { avgsaleprice: @sku.avgsaleprice, skuid: @sku.skuid, skuname: @sku.skuname } }
